<template>
  <v-app>
        ...
        <v-list-item class="pa-0">
            <v-list-item-avatar v-if="workshop.profile_photo">
                <v-img :src="workshop.profile_photo"></v-img>
            </v-list-item-avatar>
            ...
            <v-list-item-action>
                <v-menu v-if="isAuthenticated && loggedInUser.username == workshop.username" 
