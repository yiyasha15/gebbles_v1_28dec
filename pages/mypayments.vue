                 ...
                 <v-stepper v-model="e6" vertical class="elevation-0">
                    ...
                    *Event details
                    ...
                    <v-stepper-content step="1" style="border-left: none;" class="ma-0"> 
                        ...
                        <v-btn v-if="event_published" outlined small class="text-decoration-none"  color="black"
                        @click="update" :loading="progressbar" >Update</v-btn>
                        <v-btn color="black" text small outlined @click="saveAndAdd" :loading="publish_progressbar" v-if="!event_published">Publish and continue</v-btn>
