<template>
  <v-app>
       <v-container class="mt-4 mx-auto" fluid style="max-width:750px" >
      <v-btn icon class="elevation-0 text-decoration-none float-left" @click="goback()">
                <v-icon>mdi-arrow-left</v-icon>
            </v-btn>
       </v-container>
    <v-container class="rounded-lg grey lighten-5 mt-4 mx-auto" fluid style="max-width:750px" >
            <v-row class="pa-4">
    ...
    <v-container v-if="videoId" class="rounded-lg px-6 py-3 grey lighten-5 mt-2 mx-auto" style=" max-width:750px" >
            <h3 class="font-weight-light ">
                The video which inspired me
            </h3>
            <center class="py-6 hidden-xs-only">
                <youtube width="100%" height="385" :video-id= 'videoId'></youtube>
            </center>
            <center class="my-6 hidden-sm-and-up">
                <youtube width="100%" height="340" :video-id= 'videoId'></youtube>
            </center>
    </v-container>
    <v-container class="rounded-lg grey lighten-5 mt-2 py-4 mx-auto" style=" max-width:750px"  >
        <v-row>
