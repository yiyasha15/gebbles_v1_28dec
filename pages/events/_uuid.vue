<template>
  <v-app>
        ...
        <h2 v-if="event.event_battles.length>0 || event.event_subevents.length>0 || event.event_workshops.length>0" class="my-6 font-weight-medium" > Programs</h2>
        <v-row class="ma-0" >
            ...
            <v-col cols="6" sm="6" v-for="category in event.event_workshops" :key ="category.index" class="pa-1">
            <category-card :category="category" :poster="event.poster"></category-card>
            </v-col>
        </v-row>
