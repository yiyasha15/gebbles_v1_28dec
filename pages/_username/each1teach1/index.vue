<template>
    <v-app>
        ...
        <v-tab-item v-if="!firstLoad">
            <small class="ml-1 py-2 grey--text">🤝 artists {{artist.username}} gave a shoutout to</small>
        ...
        <v-tab-item v-if="!firstLoad">
            <small class="ml-1 py-2 grey--text">🤝 artists that gave {{artist.username}} a shoutout</small>
