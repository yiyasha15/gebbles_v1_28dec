<template>
   <v-container>
        ...
        <div v-if="isAuthenticated"> <v-menu transition="slide-y-transition" open-on-hover offset-y bottom left>
                ...
                <v-list>
                    ...
                    height="28"
                        ...
                        alt="img"
                    >
                    <v-list-item-title class="pl-1" ><h4 style="font-family: 'Poiret One', cursive;">gebbles</h4></v-list-item-title>
                    </v-list-item>
                    <!-- <v-list-item
                    v-if="userHasPortfolio"
                    :to="'/'+ loggedInUser.user.username"
        ...
        <v-dialog
            ...
            max-width="450">
            <center>
            <v-card max-width="450" class="px-2 pt-6 " elevation="0" outlined>
                    <nuxt-link :to="'/'" class="text-decoration-none">
                <img
        ...
        max-width="450">
            ...
            <v-card-actions class="mb-3 justify-center">
            <v-btn @click="registerUser(registrationInfo)" dark small elevation="4" class="px-8" color="black" :loading="progressbar" >Create Account</v-btn>
            </v-card-actions>
            </v-form>
            </v-card-text>
            <v-divider></v-divider>
