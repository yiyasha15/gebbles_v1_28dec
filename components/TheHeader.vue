<template>
   <!-- <v-container> -->
        ...
        <div v-if="!isAuthenticated" class=" hidden-sm-and-down">
            <v-btn small dark color="black" class="mr-2 text-decoration-none" to="/login">Sign In</v-btn>
            <v-btn small outlined  color="black" class="mr-2 text-decoration-none" to="/register">Sign Up</v-btn>
        </div>
        <div v-if="!isAuthenticated" class=" hidden-md-and-up">
            <v-btn x-small dark color="black" class="mr-2 text-decoration-none" to="/login">Sign In</v-btn>
            <v-btn x-small outlined  color="black" class="mr-2 text-decoration-none" to="/register">Sign Up</v-btn>
        </div>
        </v-toolbar>
    <!-- </v-container> -->
</template>
