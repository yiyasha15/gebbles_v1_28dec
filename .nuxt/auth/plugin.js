...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"v1/auth/login/","method":"post","propertyName":"token"},"logout":{"url":"v1/auth/logout/","method":"post"},"user":{"url":"https://gruw80hfj5.execute-api.us-east-2.amazonaws.com/dev/api/v1/auth/user/","method":"get","propertyName":"user"}},"tokenType":"","_name":"local"}))
